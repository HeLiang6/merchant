<template>
  <div>
    <el-form
      ...
      :model="formAdd"
      :rules="rules"
      style="max-height: 100%;padding: 20px 30% 20px 20px;"
    >
      ...
      <el-form :inline="true" class="citybox">
        ...
        <el-form-item :label-width="formLabelWidth" prop="citys" style="margin:0" label="城市">
      ...
      <el-form-item label="联系电话" prop="mobile_phone" :label-width="formLabelWidth">
      ...
      <el-form-item label="排序" prop="shop_name" :label-width="formLabelWidth">
        <el-input v-model="formAdd.shop_name" style="width:80px" /><span style="color:#ccc;margin-left:30px">1以上整数，越小越靠前</span>
      </el-form-item>
      ...
      <div>
        <div class="footer">
          ...
          <el-button @click="modificationAdd('formAdds')">确 定</el-button>
        </div>
      </div>
...
import { bank, province, one_industry, two_industry, Logo, fetchAdd } from '../api'
export default {
  name: 'New',
  components: {
    BaiduMap,
